...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { comany: @reference.comany, referee_name: @reference.referee_name, referee_position: @reference.referee_position, years_known: @reference.years_known }
    end
  ...
  test "should update reference" do
    patch :update, id: @reference, reference: { comany: @reference.comany, referee_name: @reference.referee_name, referee_position: @reference.referee_position, years_known: @reference.years_known }
    assert_redirected_to reference_path(assigns(:reference))
  end
